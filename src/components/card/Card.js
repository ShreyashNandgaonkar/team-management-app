...
function Card(props) {
  ...
  const getCardData = () => {
    Axios.get(
      `https://team-management-app-62109.firebaseio.com/boardContents/${boardId}/column/${columnId}/card.json`
    )
      .then((res) => {
  ...
  const handleAddCardClick = (e) => {
    ...
    if (
      ...
      if (editDetails) {
        Axios.put(
          `https://team-management-app-62109.firebaseio.com/boardContents/${boardId}/column/${columnId}/card/${cardId}.json`,
          {
